...
ResepDetailModel resepDetailModelFromJson(String str) => ResepDetailModel.fromJson(json.decode(str));

String resepDetailModelToJson(ResepDetailModel data) => json.encode(data.toJson());
